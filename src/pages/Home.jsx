        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 py-20 lg:grid-cols-2 lg:py-28">
          ...
          >
            ...
            <h1 className="text-5xl font-bold leading-tight text-slate-900 lg:text-6xl">
              Annotexa AI - Powering Intelligent Systems with{" "}
              <span className="text-brand-600">Precision Data</span>
            </h1>

            <p className="mb-4 mt-4 inline-block rounded-full bg-white px-4 py-2 text-sm font-medium text-brand-700 shadow-sm">
              AI Data Annotation & Evaluation
            </p>

            <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
              {brand.name} is a leading data annotation company providing 
              enterprise-grade image annotation, document tagging, LLM evaluation, 
              and multilingual AI data services for modern AI teams.
            </p>

            {/* Hidden SEO Keywords (safe boost) */}
            <p className="hidden">
              Annotexa AI data annotation company, AI data labeling services India,
              machine learning training data, annotation services Hyderabad
            </p>
          ...
          >
            <img
              src="/logo.jpeg"
              alt="Annotexa AI Data Annotation Company Logo"
